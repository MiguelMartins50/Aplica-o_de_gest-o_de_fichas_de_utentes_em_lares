    ...
    public partial class Atividades_func : UserControl
    {
        ...
        private void display_data()
        {
            try
            {
                ...
                cmd.CommandText = "SELECT A.idAtividade, A.Utente_idUtente, U.nome AS Utente,A.nome AS nome , A.data, A.descricao, A.Tipo_idTipo ,t.tipo FROM atividade A JOIN utente U ON A.Utente_idUtente = U.idUtente JOIN tipo t ON a.Tipo_idTipo = t.idTipo where Funcionario_idFuncionario = @iduser;";
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                textBox_nome.Text = row.Cells["nome"].Value.ToString();  // Use "Titulo" instead of "nome"
